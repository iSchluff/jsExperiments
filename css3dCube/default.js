...
(function(){
  var cube= function(mainContainer, cubeContainer){
    ...
    var setup= function(){
      ...
      cubeContainer.addEventListener("mousedown", function(event){
        mouseDown= true;
        ...
        mainContainer.addEventListener("mousemove", onMove);

        // on mouseUp remove movelistener
        var onUp= function(){
          mouseDown= false;
          mainContainer.removeEventListener('mousemove', onMove);
          mainContainer.removeEventListener('mouseup', onUp);
        };
        mainContainer.addEventListener("mouseup", onUp);
    ...
    var render= function(){
      ...
      cubeContainer.style.webkitTransform=
      cubeContainer.style.msTransform=
      cubeContainer.style.transform= mat3ToString(newMat);
    };

    setup();
  };

  cube(document.querySelector("#main"), document.querySelector("#cube"));
}());
